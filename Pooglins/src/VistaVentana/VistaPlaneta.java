...
public class VistaPlaneta extends JPanel {
	...
	public void cargarListaImagenes() throws IOException {
		/*
		 * Aca Cargamos imagenes a una lista de BufferedImage, esto esta hecho
		 * asi ya que cargando una vez todo a una lista se hace mas rapido cada
		 * vez que actualizamos la vista del planeta que leyendo cada vez del
		 * disco. Por ahi existen otras formas mejores, en internet buscamos y
		 * decia que el metodo drawImage() y leyendo una imagen era siempre
		 * lento.
		 */
	...
	private void pintarBloque(Bloque bloque) throws IOException {
		...
		case 'A':
			gra.drawImage(listaDeImagenes.get(0), 20 * bloque.getPosicionY(),
					20 * bloque.getPosicionX(),
					20 + 20 * bloque.getPosicionY(), 20 + 20 * bloque
							.getPosicionX(), 0, 0, 32, 32, null);
			return;
		case 'T':
			gra.drawImage(listaDeImagenes.get(1), 20 * bloque.getPosicionY(),
					20 * bloque.getPosicionX(),
					20 + 20 * bloque.getPosicionY(), 20 + 20 * bloque
							.getPosicionX(), 0, 0, 32, 32, null);
			break;
		case 'F':
			gra.drawImage(listaDeImagenes.get(2), 20 * bloque.getPosicionY(),
					20 * bloque.getPosicionX(),
					20 + 20 * bloque.getPosicionY(), 20 + 20 * bloque
							.getPosicionX(), 0, 0, 32, 32, null);
			break;
		case 'R':
			gra.drawImage(listaDeImagenes.get(3), 20 * bloque.getPosicionY(),
					20 * bloque.getPosicionX(),
					20 + 20 * bloque.getPosicionY(), 20 + 20 * bloque
							.getPosicionX(), 0, 0, 32, 32, null);
			break;
		case 'S':
			gra.drawImage(listaDeImagenes.get(4), 20 * bloque.getPosicionY(),
					20 * bloque.getPosicionX(),
					20 + 20 * bloque.getPosicionY(), 20 + 20 * bloque
							.getPosicionX(), 0, 0, 32, 32, null);
			break;
		case 'O':
			gra.drawImage(listaDeImagenes.get(5), 20 * bloque.getPosicionY(),
					20 * bloque.getPosicionX(),
					20 + 20 * bloque.getPosicionY(), 20 + 20 * bloque
							.getPosicionX(), 0, 0, 32, 32, null);
			break;
		case 'H':
			gra.drawImage(listaDeImagenes.get(6), 20 * bloque.getPosicionY(),
					20 * bloque.getPosicionX(),
					20 + 20 * bloque.getPosicionY(), 20 + 20 * bloque
							.getPosicionX(), 0, 0, 32, 32, null);
			break;
