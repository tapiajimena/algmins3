...
public class TunelElectroMagnetico extends Habilidad {
	...
	public Element serializar() {
		Element elementTunelElectroMagnetico = super.serializar();
		elementTunelElectroMagnetico.addAttribute("longitudFaltante", String
				.valueOf(this.longitudFaltante));
		return elementTunelElectroMagnetico;
	}

	public void recuperarEstado(Element elementoTunelElectroMagnetico) {
		this.longitudFaltante = Integer.parseInt(elementoTunelElectroMagnetico
				.attributeValue("longitudFaltante"));
	}
