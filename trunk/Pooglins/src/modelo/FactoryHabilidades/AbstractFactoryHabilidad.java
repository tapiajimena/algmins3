...
public abstract class AbstractFactoryHabilidad {
	...
	public Element serializar() {
		Element fabricaHabilidadXML = DocumentHelper.createElement(this
				.getClass().getName());
		fabricaHabilidadXML.addAttribute("cantidadDisponible", String
				.valueOf(this.cantidadDisponible));
		return fabricaHabilidadXML;
	};

	public void recuperarEstado(Element unElemento) {
		this.cantidadDisponible = Integer.parseInt(unElemento
				.attributeValue("cantidadDisponible"));
	};
}
