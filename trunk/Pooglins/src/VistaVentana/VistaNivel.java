...
public/*
       * Usar Singelton? forzar atributos estaticos?, Para cada instancia debe
       * existir un modelo distinto, asociado a la vista ,
       */
...
class VistaNivel {
	...
	panelHabildad.setLayout(new BoxLayout(panelHabildad,
		BoxLayout.PAGE_AXIS));
	...
	// detalle group es local, pero debe usarse para definir los eventos
	// creo
	...
	ventana.getContentPane().setLayout(
		new BoxLayout(ventana.getContentPane(), BoxLayout.LINE_AXIS));
